const content = {
  header: {
    title: "Professeur d'Allemand en Ligne",
    subtitle:
      "Préparez-vous aux examens officiels et obtenez des certifications en langue allemande",
  },
  nav: [
  ...
  footer: "© 2024 Professeur d'Allemand. Tous droits réservés.",
};
